...
We started with the encoding of the agreement for Mary Smith in chapter~\ref{chap:odrl0syntax} but we deferred the definition of the Coq constructs used to define that agreement. All the definitions needed to encode the agreement for Mary Smith except for the prerequisite $PrePay$ (which is not part of \ac{ACCPL}) have now been defined. More agreement examples will be given in Chapter~\ref{chap:examples}.
