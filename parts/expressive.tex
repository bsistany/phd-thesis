...
\lstset{language=Coq, frame=single, caption={Expressing Agreement of Example 2.1 in ACCPL}, label={lst:pucella21examplecoq}}
\begin{minipage}[c]{0.95\textwidth}
\begin{lstlisting}
...
\lstset{language=Coq, frame=single, caption={Fully Built Agreement of Example 2.1 in ACCPL}, label={lst:pucella21examplecoq2}}
\begin{minipage}[c]{0.95\textwidth}
\begin{lstlisting}
