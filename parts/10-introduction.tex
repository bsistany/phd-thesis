...
A policy language that was based on some sort of logic with formal semantics and also one that was minimal and extendible was clearly needed. We started by looking at Lithium and subsequently Pucella's subset of \ac{odrl}  as potential core languages. 
