...
The semantics of policies in \ac{ACCPL} are specified by translation from policy statements to decisions. We present decidability results for the decision problem that asks whether a request can be answered with a decision given a policy and we show that the translation algorithm meets its specification. 
