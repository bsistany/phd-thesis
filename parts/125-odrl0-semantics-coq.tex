...
The decision procedure $eq\_nat\_dec$ compares two natural numbers, returning a proof term if they are equal or a proof term if they are not (see listing~\ref{lst:eqnatdeccoq}).
