...
The \syn{trans_policy_negative} translation function (see listing~\ref{lst:transNegativeCoq}) starts by calling the function \syn{trans_pp_list_trans_policy_negative} on a list of primPolicys. Note that \syn{trans_pp_list_trans_policy_negative} is not listed here since it follows the exact pattern as \syn{trans_pp_list_trans_policy_positive} (see listing~\ref{lst:transListOfPositiveCoq}).
