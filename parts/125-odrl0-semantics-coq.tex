...
\lstset{language=Coq, frame=single, caption={\syn{getCount} Function},label={lst:envsConsistentcoq}}
\begin{minipage}[c]{0.95\textwidth}
\begin{lstlisting}
...
The \syn{trans_policy_positive} translation function (see listing~\ref{lst:transPositiveCoq}) starts by calling the function \syn{trans_pp_list_trans_policy_positive} (see listing~\ref{lst:transListOfPositiveCoq}) on the list of \syn{primPolicy}s.
